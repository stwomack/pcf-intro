...
====
----
Using manifest file /Users/pivotal/cbusch/pcf-intro/session_02/lab_01/spring-music/manifest.yml <1>

Creating app spring-music in org pcf-intro / space instructor as cbusch@pivotal.io...
OK <2>
...
Uploading app files from: /Users/pivotal/cbusch/pcf-intro/session_02/lab_01/spring-music/build/libs/spring-music.war
Uploading 569.7K, 90 files
Done uploading
OK

Starting app spring-music in org pcf-intro / space instructor as cbusch@pivotal.io... <6>
...
Showing health and status for app spring-music in org pcf-intro / space instructor as cbusch@pivotal.io... <11>
OK
...
+
Be sure to click on the `information icon` (_i_) in the top right-hand corner of the UI.
