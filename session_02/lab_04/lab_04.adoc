...
+
image::../../Common/images/appsman-3.png[]
...
=== For Operators - external app logs (OPTIONAL)
...
Cloud Foundry's http://docs.cloudfoundry.org/concepts/architecture[Health Manager] actively monitors the health of our application processes and will restart them should they crash. 
